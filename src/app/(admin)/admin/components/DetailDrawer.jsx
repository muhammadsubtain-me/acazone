          ...
          <section>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-4 flex flex-col gap-2">
              ...
              {inquiry.contact_type === 'email' ? (
                <>
                  <DetailRow label="Email" value={inquiry.contact} />
                  {inquiry.contact && (
                    <a
                      href={`mailto:${inquiry.contact}`}
                      className="mt-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-semibold hover:bg-blue-500/20 transition-all"
                    >
