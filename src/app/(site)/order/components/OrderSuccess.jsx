...
export default function OrderSuccess({ name, subject, serviceLabel, contactType, dial, phone, email, onReset }) {
  ...
  return (
    <div className="text-center py-10 animate-fade-in">
      ...
      <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.06] text-xs text-[var(--color-text-faint)] max-w-sm mx-auto mb-8">
        {isEmail ? (
          <>We will reach out to you at <span className="text-white font-semibold">{email}</span> within 15 minutes.</>
        ) : (
