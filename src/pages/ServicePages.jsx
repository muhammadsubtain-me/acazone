...
export function MechanicalPage() {
  return (
    <ServicePage
      ...
      topics={[
        'Thermodynamics', 'Fluid Mechanics', 'Statics & Dynamics', 'Heat Transfer',
        'Manufacturing Processes', 'CAD/CAM', 'Robotics & Automation', 'Materials Science',
        'Vibration Analysis', 'Control Systems', 'FEA Analysis', 'HVAC Systems',
        'Machine Design', 'Kinematics', 'Solid Mechanics', 'Renewable Energy',
      ]}
      benefits={[
...
export function ElectricalPage() {
  return (
    <ServicePage
      ...
      topics={[
        'Circuit Analysis', 'Digital Electronics', 'Power Systems', 'Signal Processing',
        'Electromagnetics', 'Control Theory', 'Embedded Systems', 'PCB Design',
        'VLSI Design', 'Microcontrollers', 'Communication Systems', 'Power Electronics',
        'Electric Machines', 'Renewable Energy', 'FPGA Programming', 'Analog Circuits',
      ]}
      benefits={[
...
export function ChemicalPage() {
  return (
    <ServicePage
      ...
      topics={[
        'Chemical Thermodynamics', 'Reaction Kinetics', 'Mass Transfer', 'Heat Transfer',
        'Process Design', 'Fluid Flow', 'Separation Processes', 'Process Control',
        'Polymer Science', 'Catalysis', 'Plant Design', 'Safety & Hazard Analysis',
        'Biochemical Engineering', 'Environmental Eng.', 'Electrochemistry', 'Nanotechnology',
      ]}
      benefits={[
  ...
  return (
    <ServicePage
      ...
      topics={[
        ...
        'Web Development', 'Machine Learning', 'Artificial Intelligence', 'Computer Networks',
        'Software Engineering', 'Cybersecurity', 'Cloud Computing', 'Mobile Development',
        'Computer Graphics', 'Compiler Design', 'Distributed Systems', 'DevOps',
      ]}
      benefits={[
