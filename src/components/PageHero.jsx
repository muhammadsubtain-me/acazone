export default function PageHero({ title, subtitle }) {
  return (
    <section className="-mt-16 pt-36 pb-20 bg-[var(--color-surface)] text-center relative overflow-hidden">
      ...
      <div className="relative max-w-3xl xl:max-w-4xl 3xl:max-w-5xl mx-auto px-4 md:px-6">
        <h1 className="font-display text-3xl md:text-4xl lg:text-5xl xl:text-6xl 3xl:text-7xl font-bold mb-4 text-[var(--color-text-heading)]">{title}</h1>
